...
static doublereal c_b105 = -.15151515;
static real c_b106 = -1.f;
static doublereal c_b112 = .14;
...
/*          #              (IGRF-11 coefficients added on Nov 30, 2010)              # */
/*          ########################################################################## */
...
/*     THIS VERSION OF THE CODE ACCEPTS DATES FROM 1965 THROUGH 2015. */
...
/* Subroutine */ int recalc_08__(integer *iyear, integer *iday, integer *
	ihour, integer *min__, integer *isec, real *vgsex, real *vgsey, real *
	vgsez)
{
    /* Initialized data */
    ...
    static real h00[105] = { 0.f,0.f,5186.1f,0.f,-2481.6f,-458.f,0.f,-227.6f,
	    ...
	    -.9f };
    static real g05[105] = { 0.f,-29554.6f,-1669.f,-2337.2f,3047.7f,1657.8f,
	    1336.3f,-2305.8f,1246.4f,672.5f,920.6f,798.f,210.7f,-379.9f,100.f,
	    -227.f,354.4f,208.9f,-136.5f,-168.1f,-13.6f,73.6f,69.6f,76.7f,
	    ...
	    -6.1f,1.4f,-2.4f,-.2f,3.1f,.3f,2.1f,3.8f,-.2f,-2.1f,2.9f,-1.6f,
    ...
    static real h05[105] = { 0.f,0.f,5078.f,0.f,-2594.5f,-515.4f,0.f,-198.9f,
	    ...
	    8.1f,2.9f,-7.7f,6.f,0.f,2.2f,.1f,4.5f,4.8f,-6.7f,-1.f,-3.5f,-.9f,
    ...
    static char fmt_10[] = "(//1x,\002**** RECALC_08 WARNS: YEAR IS OUT OF I"
	    "NTERVAL 1965-2015: IYEAR=\002,i4,/,6x,\002CALCULATIONS WILL BE D"
    ...
    static real dt, sq, dj, dx1, dy1, dz1, dz2, dz3, dy2, dy3, dx2, dx3, 
	    g_10__, g_11__, h_11__;
    static integer mnn;
    ...
    static cilist io___145 = { 0, 6, 0, fmt_10, 0 };
    static cilist io___146 = { 0, 6, 0, fmt_10, 0 };
...
/* L150: */
    ...
    g_10__ = -geopack2_1.g[1];
    g_11__ = geopack2_1.g[2];
    h_11__ = geopack2_1.h__[2];
...
/* Computing 2nd power */
    ...
    geopack1_2.sl0 = -h_11__ / sqq;
    geopack1_2.cl0 = -g_11__ / sqq;
    geopack1_2.st0 = sqq / sqr;
    geopack1_2.ct0 = g_10__ / sqr;
...
/*     LAST MODIFICATION:  APR 21, 2008   (SEE ERRATA AS OF THIS DATE) */
	...
	real *yy, real *zz, integer *l, integer *lmax)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___267 = { 0, 6, 0, fmt_10, 0 };
...
/*  replace the coordinates of the last (L-th) point in the XX,YY,ZZ arrays */
/*   so that they correspond to the estimated footpoint position {XF,YF,ZF}, */
/*   satisfying:  sqrt(XF**2+YF**2+ZF**2}=R0 */
...
/*  BOUNDARY POINT: */
    ...
    t96_mgnp_08__(&p, &c_b106, xgsw, ygsw, zgsw, &xmt96, &ymt96, &zmt96, dist,
	     &id96);
